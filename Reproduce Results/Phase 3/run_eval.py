"""
Phase 3 agent-pipeline evaluation runner.
...
The same script is used for the preliminary 4-model check (small circuit
set) and the full Phase 3 evaluation (large circuit set) — only the
`--circuits_jsonl` differs.
